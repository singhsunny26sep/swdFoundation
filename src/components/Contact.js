        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/about" className="text-gray-700 hover:text-red-600 transition-colors font-medium">About Us</Link>
              <Link to="/volunteer" className="text-gray-700 hover:text-red-600 transition-colors font-medium">Volunteer</Link>
              <Link to="/gallery" className="text-gray-700 hover:text-red-600 transition-colors font-medium">Gallery</Link>
